...
main() {
    ...
    echo -e "    1. ${YELLOW}jshadow /login${NC}         — Connect Cloudflare credentials"
    echo -e "    2. ${YELLOW}jshadow -t TARGET${NC}      — Start pentesting"
    echo ""
    echo -e "  ${CYAN}Quick commands:${NC}"
    echo -e "    jshadow --target 192.168.1.0/24"
    echo -e "    jshadow -t example.com --lang id"
    echo ""

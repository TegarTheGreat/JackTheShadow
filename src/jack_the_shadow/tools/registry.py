...
def build_default_registry() -> ToolRegistry:
    """Create a registry pre-loaded with all 30 built-in tools."""
    ...
    from jack_the_shadow.tools.builtin.encoder import EncoderDecoderTool
    ...
    from jack_the_shadow.tools.builtin.hash_tool import HashAnalyzeTool
    ...
    from jack_the_shadow.tools.builtin.payload import PayloadGenerateTool
    ...
    from jack_the_shadow.tools.builtin.shodan_tool import ShodanTool

...
STRINGS: dict[str, str] = {
    ...
    "api.rate_limited": "Rate limited by Cloudflare (429). Try again in a moment or switch models with /model.",
    ...
    "cmd.phase.desc": "Switch pentest phase (recon/enum/vuln/exploit/report)",
